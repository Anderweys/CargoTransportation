...
public class GetDeliveryInfoQueryHandler : IRequestHandler<GetDeliveryInfoQuery, DeliveryInfoDTO>
{
    ...
    private readonly ILogger<GetDeliveryInfoQueryHandler> _logger;

    public GetDeliveryInfoQueryHandler(
        IMediator mediator,
        IDistributedCache cache,
        ILogger<GetDeliveryInfoQueryHandler> logger,
    ...
    public async Task<DeliveryInfoDTO> Handle(GetDeliveryInfoQuery request, CancellationToken cancellationToken)
    {
        ...
        catch (ArgumentNullException e)
        {
            _logger.LogCritical(
                ...
                e.Message,
                e.StackTrace,
                nameof(GetDeliveryInfoQueryHandler),
